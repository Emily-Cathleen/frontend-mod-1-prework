...
// log that variable to the console.
var warningToHarry = "Harry Potter must not return to Hogwarts!";
console.log(warningToHarry);
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
My first name is a string. isHungry is a boolean value. And numberOfPets is an integer.
