...
// EXPLAIN: 012 is logged to the console because is the variable i is set to 0,
// and the conditional
// i is less than 5 and increment expression is i plus 1.
...
//This will print out the index as well.
 ...
 for (var i = 0; i <10; i++){
    console.log('Sally sells seashells down by the seashore', i);
  }
//-------------------
